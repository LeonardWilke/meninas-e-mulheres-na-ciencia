...
// Sessão
app.use(session({
  secret: 'instituto2019informatica3gabriela',
  resave: true,
...
app.get('/analises', async function (req, res) {
  ...
  const numeroRegistros = await Analise.count()
...
var transporter = nodemailer.createTransport({
  ...
  auth: {
    ...
    pass: '2020mmc18072902'
  }
})

const JWT_SECRET = 'meninasemulheresinformatica3gabriela'
